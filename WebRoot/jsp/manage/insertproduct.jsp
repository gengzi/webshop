					...
					<table class="biaoge" width="100%" border="0" cellpadding="5"
						...
						<tbody>
							...
							<form enctype="multipart/form-data"
								action="<c:url  value='/ProductServlet?method=5'/>"
								method="post" onsubmit="return onSubmit()">
								<tr class="bg_head" align="center">
									<th width="15%"><input type="text" name="name" size="10" />
									</th>
									<th width="10%"><input type="text" name="price" size="2" />元
									</th>
									<th width="10%"><select name="category">
									...
									<th width="10%"><input type="text" name="pnum" size="2" />个
									</th>
									<th width="10%"><input type="file" name="file" size="10" />
									</th>
									<th width="20%"><input type="text" name="description"
										size="35" />
									</th>
									<th width="5%"><input type="submit" value="提交" />
									</th>
								</tr>
							</form>
						</tbody>
